...
EXPECTED_COSTS = {
    "gemini-3.1-pro": {"input": 2.00, "cached_input": 1.00, "output": 12.00},
    "gemini-3.1-pro-high": {"input": 2.00, "cached_input": 1.00, "output": 12.00},
    "gemini-3.1-pro-low": {"input": 2.00, "cached_input": 1.00, "output": 12.00},
    "gemini-3.0-flash": {"input": 0.075, "cached_input": 0.0375, "output": 0.30},
    "gemini-2.5-pro": {"input": 2.00, "cached_input": 1.00, "output": 8.00},
    "gemini-2.5-flash": {"input": 0.075, "cached_input": 0.0375, "output": 0.30},
    "gemini-1.5-pro": {"input": 1.25, "cached_input": 0.625, "output": 5.00},
    "gemini-1.5-flash": {"input": 0.075, "cached_input": 0.0375, "output": 0.30},
    "gpt-4o": {"input": 5.00, "cached_input": 2.50, "output": 15.00},
    "gpt-4o-mini": {"input": 0.15, "cached_input": 0.075, "output": 0.60},
    "claude-3-5-sonnet": {"input": 3.00, "cached_input": 1.50, "output": 15.00},
    "claude-3-5-haiku": {"input": 1.00, "cached_input": 0.50, "output": 5.00},
    "claude-3-7-sonnet": {"input": 3.00, "cached_input": 1.50, "output": 15.00},
    "default": {"input": 2.00, "cached_input": 1.00, "output": 12.00}
}
...
def generate_receipt():
    ...
    uncached_cost = (base_read_tokens / 1_000_000) * rates["input"]
    cached_cost = ((base_read_tokens * max(0, args.turns - 1)) / 1_000_000) * rates.get("cached_input", rates["input"])
    output_cost = (modified_tokens / 1_000_000) * rates["output"]
    
    est_cost = uncached_cost + cached_cost + output_cost
